...
create table t_productos (
	id_productos int(10) PRIMARY KEY,
...
ALTER table t_sucursal RENAME COLUMN nombreo to nombre

create table t_vendedor (
	id_vendedor int(10) PRIMARY KEY,
	nombre varchar(50) not null,
	apellido varchar(50) not null,
	id_sucursal int(10),
	FOREIGN KEY (id_sucursal) REFERENCES t_sucursal(id_sucursal)
	);
...
create table t_ventas (
	...
	FOREIGN KEY (id_producto) REFERENCES  t_productos(id_productos),
	FOREIGN KEY  (id_vendedor) references t_vendedor(id_vendedor)
	);


INSERT INTO t_clientes (id_clientes, nombre, apellido, edad, sexo) VALUES
	(58390, 'Octavio', 'Ruiz', 27, 'M'),
	(58391, 'Diego', 'Fernandez', 32, 'M'),
	(58392, 'Omar', 'Garcia', 24, 'M'),
	(58393, 'Maria', 'Luna', 26, 'F'),
	(58394, 'Silvia', 'ZuÒiga', 35, 'F'),
...
INSERT INTO `t_proveedor` (`id_proveedor`, `nombre`, `apellido`, `direccion`) VALUES
...
INSERT INTO t_productos (id_productos, modelo, marca, precio, id_proveedor) VALUES
...
INSERT INTO `t_vendedor` (`id_vendedor`, `nombre`, `apellido`, `id_sucursal`) VALUES
	(67840, 'Alberto', 'Ascencio', 23562),
	(67841, 'Paulina', 'Rivera', 23562),
	(67842, 'Jose', 'Bueno', 23564),
	(67843, 'Eduardo', 'Telones', 23564),
	(67844, 'Martha', 'Mota', 23561),
	(67845, 'Alonso', 'Garcia', 23561),
	(67846, 'Diego', 'Trenes', 23563),
	(67847, 'Monica', 'Diaz', 23563),
	(67848, 'Maricela', 'Hernandez', 23560),
	(67849, 'Joel', 'Rico', 23560);

INSERT INTO `t_ventas` (`id_ventas`, `id_clientes`, `id_producto`, `id_vendedor`, `fecha`) VALUES
